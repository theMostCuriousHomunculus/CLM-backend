...
export default async function (card) {
    ...
    let art_crop, back_image, image, mana_cost, meldResult, meldResultPart, type_line;
    switch (layout) {
        case 'adventure':
        ...
        case 'meld':
            ...
            mana_cost = card.mana_cost;
            type_line = card.type_line;
            meldResultPart = card.all_parts.find((part) => part.component === 'meld_result');
            meldResult = await axios.get(meldResultPart.uri);
...
//# sourceMappingURL=format-scryfall-card-data.js.map